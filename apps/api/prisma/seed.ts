...
async function main() {
  const products = [
    {
      ...
      description:
        "For iPhone 12 Pro Max 256GB Fully Unlocked Factory Cell Phone Second Hand Telefone A+ 99% Used Cellphone for iPhone 12 Promax",
      price: 245,
      imageUrl:
        "https://s.alicdn.com/@sc04/kf/A2e90ef90109c4af4a501ca9e4d3b6d2a9.jpeg_720x720q50.jpg",
      stockQuantity: 10,
    ...
    },
    {
      ...
      description:
        "Wholesale 99% New Original US Version Unlocked Used Mobile Phones Low Price for iPhone 12 Mini 12 Pro Max",
      price: 235,
      imageUrl:
        "https://s.alicdn.com/@sc04/kf/Heba994a30b9e43b285aeb04d2568703dF.jpg_720x720q50.jpg",
      stockQuantity: 6,
      minimumOrderQuantity: 1,
      category: "iphone",
      gallery: [
    ...
    },
    {
      ...
      description:
        "Cheap Used Phones Z Flip3 Wholesale Used Cell Phones Fold Bulk Smartphone Use Mobile Phone Refurbished Low Price 5g",
      price: 200,
      imageUrl:
        "https://s.alicdn.com/@sc04/kf/H16da993b44654e1398b65a20506a1b59D.jpg_720x720q50.jpg",
      stockQuantity: 6,
      minimumOrderQuantity: 1,
      category: "samsung",
      gallery: [
    ...
    },
    {
      ...
      description:
        "Factory Cheap Wholesale Used Smartphone for 15 Promax Unlocked Original Cell Phone for Sale at Low Price",
      price: 230,
      imageUrl:
        "https://s.alicdn.com/@sc04/kf/H8322bc02d6a4448ba300b72ffc5a1be3A.jpg_720x720q50.jpg",
      stockQuantity: 100,
    ...
    },
    {
      ...
      price: 191,
      imageUrl:
        "https://s.alicdn.com/@sc04/kf/H73fdf747f53e4985b4c10f05080cec23y.jpg_720x720q50.jpg",
      stockQuantity: 60,
    ...
    },
    {
      ...
      description:
        "Used Apple iPhone 13 14 15 Pro Max 13 14 15 Pro 13 14 15 128GB / 512GB Unlocked Used Mobile Phone",
      price: 385,
      imageUrl:
        "https://s.alicdn.com/@sc04/kf/He3a965d918d743de9f51141572a8ebadl.jpg_720x720q50.jpg",
      stockQuantity: 5,
      minimumOrderQuantity: 1,
      category: "iphone",
      gallery: [
    ...
    },
    {
      ...
      description:
        "12promax Wholesale Original 99 New Smartphone for iphone 8 8plus Xr Xsmax 11 11pro 12 12promax Used Unlocked Mobile Phones",
      price: 168,
      imageUrl:
        "https://s.alicdn.com/@sc04/kf/H09623fb0485b4c8ba2fa19c07253d67cc.jpg_720x720q50.jpg",
      stockQuantity: 60,
      minimumOrderQuantity: 1,
      category: "iphone",
      gallery: [
    ...
    },
    {
      ...
      description:
        "99% New Original Used Mobile Phones Unlocked Smart Phones S24 Ultra 5G for Samsung Galaxy S24 Ultra Cell Phone",
      price: 558,
      imageUrl:
        "https://s.alicdn.com/@sc04/kf/H74a4fb2e8c60461a9100cbd35d05ca95P.jpg_720x720q50.jpg",
      stockQuantity: 20,
      minimumOrderQuantity: 1,
      category: "samsung",
      gallery: [
    ...
    },
    {
      ...
      description:
        "Wholesale Google Pixel 8 Lobal Edition Smartphone 99% New for Unlocked Mobile Phones 4700mah High-Capacity",
      price: 399,
      imageUrl:
        "https://s.alicdn.com/@sc04/kf/H71e17757d4fa40f8bf79ade023e9d31a4.jpg_720x720q50.jpg",
      stockQuantity: 200,
      minimumOrderQuantity: 1,
      category: "google",
      gallery: [
    ...
    },
    {
      ...
      description:
        "For Google Pixel 9 Used Mobile Phone Unlocked Android 5G Original Brand New Unlocked 6.4 Inch Mobile Phones",
      price: 600,
      imageUrl:
    ...
    },
    {
      ...
      description:
        "High Quality Original Genuine for Google Pixel 9 Pro Fold Smart Phone Fold 5G Unlocked Sim Free and Expand 8inch Large Screen",
      price: 502,
      imageUrl:
        "https://s.alicdn.com/@sc04/kf/Hcf6f3bfcc71c43f1b44c9e7f9b906bf6z.jpg_720x720q50.jpg",
      stockQuantity: 30,
      minimumOrderQuantity: 2,
      category: "google",
      gallery: [
    ...
    },
    {
      ...
      description:
        "Original Genuine for Google Pixel 8 Pro A+ Second Hand Mobile Phones 99% New Unlocked Mobile Phones",
      price: 498,
      imageUrl:
        "https://s.alicdn.com/@sc04/kf/Hbcec9ac27944478db49cd882739238efs.jpg_720x720q50.jpg",
      stockQuantity: 200,
      minimumOrderQuantity: 2,
      category: "google",
      gallery: [
  ...
  const search_queries = [
    { query: "Iphone 12 pro max", count: 0 },
    { query: "Iphone 15 pro", count: 0 },
    { query: "Google Pixel", count: 0 },
    { query: "Galaxy S24", count: 0 },
  ...
  products.forEach(async (p, i) => {
    ...
    await prisma.product_variant.createMany({
      data: p.variants.map((variant) => ({
        productId: createdProduct.id,
        name: variant.name,
        value: variant.value,
        priceDiff: 0, // Assuming no price difference for variants
        stockDiff: 0, // Assuming no stock difference for variants
      })),
    });
  ...
  for (const q of search_queries) {
    const createdQuery = await prisma.search_query.create({
      data: {
        query: q.query,
        count: q.count,
      },
